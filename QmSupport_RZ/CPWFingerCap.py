...
class MyCPWFingercap(QComponent):
    ...
    def make(self):
        ...
        south_points = [((N * p.cap_width + (N - 1) * p.cap_gap)/2,-(p.cap_gap + 2 * p.cap_width + p.finger_length)/2),
                        (p.south_width/2,-(p.cap_gap + 2 * p.cap_width + p.finger_length)/2-p.cap_length),
                        (-p.south_width/2,-(p.cap_gap + 2 * p.cap_width + p.finger_length)/2-p.cap_length),
                        (-(N * p.cap_width + (N - 1) * p.cap_gap)/2,-(p.cap_gap + 2 * p.cap_width + p.finger_length)/2)]
        
        
        north_points = [((N * p.cap_width + (N - 1) * p.cap_gap)/2,(p.cap_gap + 2 * p.cap_width + p.finger_length)/2),
                        (p.north_width/2,(p.cap_gap + 2 * p.cap_width + p.finger_length)/2+p.cap_length),
                        (-p.north_width/2,(p.cap_gap + 2 * p.cap_width + p.finger_length)/2+p.cap_length),
                        (-(N * p.cap_width + (N - 1) * p.cap_gap)/2,(p.cap_gap + 2 * p.cap_width + p.finger_length)/2)]
        ...
        cap_etch_points = [((p.south_width/2+p.south_gap),-(p.cap_gap + 2 * p.cap_width + p.finger_length)/2-p.cap_length),
                           (-(p.south_width/2+p.south_gap),-(p.cap_gap + 2 * p.cap_width + p.finger_length)/2-p.cap_length),
                           (-(p.pocket_width/2),-(p.cap_gap + 2 * p.cap_width + p.finger_length)/2),
                           (-(p.pocket_width/2),(p.cap_gap + 2 * p.cap_width + p.finger_length)/2),
                           (-(p.south_width/2+p.south_gap),(p.cap_gap + 2 * p.cap_width + p.finger_length)/2+p.cap_length),
                           ((p.south_width/2+p.south_gap),(p.cap_gap + 2 * p.cap_width + p.finger_length)/2+p.cap_length),
                           ((p.pocket_width/2),(p.cap_gap + 2 * p.cap_width + p.finger_length)/2),
        ...
        print(cap_etch_points)

        north_cap = draw.Polygon(north_points)
        south_cap = draw.Polygon(south_points)
        cap_etch = draw.Polygon(cap_etch_points)

        north_Line = draw.LineString([[-p.north_width/2,(p.cap_gap + 2 * p.cap_width + p.finger_length)/2+p.cap_length],
                                     [p.north_width/2,(p.cap_gap + 2 * p.cap_width + p.finger_length)/2+p.cap_length]])
        
        south_Line = draw.LineString([[p.south_width/2,-(p.cap_gap + 2 * p.cap_width + p.finger_length)/2-p.cap_length],
                                     [-p.south_width/2,-(p.cap_gap + 2 * p.cap_width + p.finger_length)/2-p.cap_length]])

        #Rotate and Translate
        c_items = [north_cap, south_cap, cap_body, cap_etch, north_Line, south_Line]
        c_items = draw.rotate(c_items, p.orientation, origin=(0, 0))
        c_items = draw.translate(c_items, p.pos_x, p.pos_y)
        [north_cap, south_cap, cap_body, cap_etch, north_Line, south_Line] = c_items
        ...
        self.add_qgeometry('poly', {'north_cap': north_cap}, layer=p.layer)
        self.add_qgeometry('poly', {'south_cap': south_cap}, layer=p.layer)
        ...
        self.add_pin('north_end',north_Line.coords,width=p.north_width)
        self.add_pin('south_end',south_Line.coords,width=p.north_width)
